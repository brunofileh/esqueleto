...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <div class="form-group has-feedback">
            <?= $form->field($model, 'txt_senha')->passwordInput(['placeholder' => $model->getAttributeLabel("txt_senha"), 'autocomplete' => 'off']); ?>
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
        </div>
        <div class="form-group has-feedback">
            <?= $form->field($model, 'txt_senha_confirma')->passwordInput(['placeholder' => $model->getAttributeLabel("txt_senha_confirma"), 'autocomplete' => 'off', 'onpaste' => 'return false']) ?>
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    <?= Html::submitButton('Salvar nova senha' . ' <i class="glyphicon glyphicon-log-in"></i> ', ['class' => 'btn btn-success btn-block btn-flat', 'name' => 'register-button']) ?>
                </div>
            </div>
        </div>
...
<?php $this->registerJs("$('#tabusuariossearch-txt_senha').focus();", View::POS_END) ?>